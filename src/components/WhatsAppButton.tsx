...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="group fixed bottom-6 right-6 z-30 flex items-center gap-2 rounded-full bg-forest-700 py-3 pl-3 pr-3 text-cream-50 shadow-lg shadow-forest-900/20 transition-all duration-300 hover:pr-5 md:bottom-8 md:right-8"
    >
